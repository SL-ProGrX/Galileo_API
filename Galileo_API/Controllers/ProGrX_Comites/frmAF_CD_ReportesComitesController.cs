...
namespace Galileo_API.Controllers.ProGrX_Comites
{
    ...
    public class FrmAfCdReportesComitesController : ControllerBase
    {
        ...
        {
            return FrmAfCdReportesComitesBl.AF_CD_ReportesComites_Catalogo_Obtener(CodEmpresa);
        }
        ...
        {
            return FrmAfCdReportesComitesBl.AF_CD_ReportesComites_Definicion_Obtener(CodEmpresa, codigo);
        }
        ...
        {
            return FrmAfCdReportesComitesBl.AF_CD_ReportesComites_TiposReporte_Obtener(CodEmpresa, codigo);
        }
