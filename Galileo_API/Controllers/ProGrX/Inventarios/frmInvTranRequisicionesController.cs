...
namespace Galileo.Controllers
{
    ...
    public class FrmInvTranRequisicionesController : ControllerBase
    {
        ...
        public ErrorDto<TranRequisicionData> InvTranRequisicion_Obtener(
            ...
            int CodRequisicion)
        {
            return _bl.InvTranRequisicion_Obtener(
                CodEmpresa,
                CodRequisicion);
        }
        ...
        public ErrorDto<List<InvReqProduc>> InvRequesicionProduc_Obtener(
            ...
            int CodRequisicion)
        {
            return _bl.InvRequesicionProduc_Obtener(
                CodEmpresa,
                CodRequisicion);
        }
        ...
        public ErrorDto<TranRequisicionData> InvTranRequisicion_scroll(
            ...
            int? CodRequisicion)
        {
            return _bl.InvTranRequisicion_scroll(
                CodEmpresa,
                scrollValue,
                CodRequisicion);
        }
        ...
        public ErrorDto InvTranRequesicion_Eliminar(
            ...
            int CodRequisicion)
        {
            return _bl.InvTranRequesicion_Eliminar(
                CodEmpresa,
                CodRequisicion);
        }
        ...
        {
            return _bl.InvRequesicionProduc_Insertar(
                CodEmpresa,
                CodRequisicion,
                producLineas);
        }
        ...
        public ErrorDto<List<TranRequisicionData>> InvTranPlantilla_Obtener(
            ...
            string? GeneraFecha)
        {
            return _bl.InvTranPlantilla_Obtener(
                CodEmpresa,
                CodRequisicion,
                GeneraUser,
                GeneraFecha);
        ...
        public ErrorDto<List<TranRequisicionData>> InvTranRequisiciones_Lista(
            ...
            string estado)
        {
            return _bl.InvTranRequisiciones_Lista(
                CodEmpresa,
                usuario,
                columna,
                estado);
        ...
        public ErrorDto InvRequisicionProduc_Eliminar(
            ...
            int Linea)
        {
            return _bl.InvRequisicionProduc_Eliminar(
                CodEmpresa,
                CodRequisicion,
                Linea);
        }
        ...
        public ErrorDto<List<CatalogosLista>> UENS_Obtener(
            int CodEmpresa)
        {
        ...
        public ErrorDto<List<InvRequsUsuarioRecibe>>
            UsuarioRecibeLista_Obtener(
                int CodEmpresa,
                string cod_unidad)
        {
            return _bl.UsuarioRecibeLista_Obtener(
                CodEmpresa,
                cod_unidad);
        }
        ...
        public ErrorDto<List<InvRequsUsuarioRecibe>>
            UsuariosActivoLista_Obtener(int CodEmpresa)
        {
        ...
        {
            return _bl.ProductosRequesicionesActivo_Obtener(
                CodEmpresa,
                invReqFiltros);
        }
