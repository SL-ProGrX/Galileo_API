...
namespace Galileo_API.Controllers.ProGrX_Beneficios
{
    ...
    public class FrmAfBeneficiosGruposController : ControllerBase
    {
        ...
        public ErrorDto<AfiBeneGruposLista> AfiBeneGrupos_Obtener(int CodCliente, string? filtros)
            => _bl.AfiBeneGrupos_Obtener(CodCliente, filtros);
        ...
        public ErrorDto<List<AfiBeneGrupos>> AfiBeneGrupoExportar(int CodCliente, string? filtros)
            => _bl.AfiBeneGrupoExportar(CodCliente, filtros);
        ...
        [HttpPut("AfiAsignaciones_Actualizar")]
        public ErrorDto AfiAsignaciones_Actualizar(int CodCliente, [FromBody] AfiAsignacionRequest request)
            => _bl.AfiAsignaciones_Actualizar(CodCliente, request);
    }
}
