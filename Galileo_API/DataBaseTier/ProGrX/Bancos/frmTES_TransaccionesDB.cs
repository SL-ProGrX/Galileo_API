    ...
    public class frmTES_TransaccionesDB
    {
        ...
        private ErrorDTO TES_Transaccion_Insertar(int CodEmpresa, string usuario, TES_TransaccionDTO transaccion)
        {
            ...
            try
            {
                ...
                {
                    fechaAutoriza = $"'{fechaAutoriza:yyyy-MM-dd HH:mm:ss}'";
                }
        ...
        /// <summary>
        /// Metodo para actualizar el detalle del asiento de la transacción
        /// </summary>
        /// <param name="CodEmpresa"></param>
        /// <param name="solicitud"></param>
        ...
        /// <summary>
        /// Metodo para validar si una empresa está habilitada para realizar transacciones SINPE
        /// </summary>
        /// <param name="CodEmpresa"></param>
        /// <returns></returns>
