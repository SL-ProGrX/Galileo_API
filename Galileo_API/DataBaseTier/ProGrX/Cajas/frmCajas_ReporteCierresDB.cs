...
namespace Galileo_API.DataBaseTier.ProGrX.Cajas
{
    public class FrmCajasReporteCierresDb(IConfiguration config)
    {
        ...
        private const string OperacionRealizadaCorrectamente = "Operaci�n realizada correctamente";
        ...
        /// <summary>
        ///  reutilizable para marcar recibe/revisa sin SQL din�mico inseguro
        /// </summary>
            ...
            string tipo)
        {
            ...
            // Elegimos SQL entre constantes ? sin concatenar columnas din�micamente
            string sql = tipo switch
            {
                ...
                "REVISA" => @"
                    ...
                    WHERE COD_CAJA = @codCaja
                      AND COD_APERTURA = @codApertura",
                _ => throw new ArgumentException("Tipo de cierre no v�lido", nameof(tipo))
            };
