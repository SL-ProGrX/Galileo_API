        ...
        private ErrorDto Cajas_Recaudadores_Insertar(int CodEmpresa, string usuario, CajasRecaudadorData recaudador)
        {
            ...
            VALUES
                ...
                _Security_MainDB.Bitacora(new BitacoraInsertarDto
                {
                    ...
                    DetalleMovimiento = $"Cajas_Recaudadores: Recaudador {recaudador.cod_recaudador}"
                });
            }
            catch (Exception ex)
            {
        ...
        public ErrorDto Cajas_Recaudadores_Eliminar(int CodEmpresa, string usuario, string cod_recaudador)
        {
            ...
            WHERE cod_recaudador = @cod_recaudador;";
                ...
                _Security_MainDB.Bitacora(new BitacoraInsertarDto
                {
                    ...
                    DetalleMovimiento = $"Cajas_Recaudadores: Recaudador {cod_recaudador}"
                });
        ...
        private ErrorDto Cajas_Recaudadores_Contactos_Insertar(int CodEmpresa,string usuario,CajasRecaudadorContactoData contacto)
        {
            ...
            try
            {
                ...
                _Security_MainDB.Bitacora(new BitacoraInsertarDto
                {
                    ...
                    Modulo = vModulo,
                    Movimiento = "Registra - WEB",
                    DetalleMovimiento = $"Cajas_Recaudadores: Contacto {contacto.linea} recaudador {contacto.cod_recaudador}"
                });
            }
            catch (Exception ex)
            {
            ...
            WHERE cod_recaudador = @cod_recaudador
              AND linea          = @linea;";
                ...
                _Security_MainDB.Bitacora(new BitacoraInsertarDto
                {
                    ...
                    Modulo = vModulo,
                    Movimiento = "Elimina - WEB",
                    DetalleMovimiento = $"Cajas_Recaudadores: Contacto {linea} recaudador {cod_recaudador}"
                });
            }
            catch (Exception ex)
            {
