...
{
    public class FrmCOAplExcInformesDB
    {
        private readonly PortalDB _portalDB;

        public FrmCOAplExcInformesDB(IConfiguration config)
        {
            _portalDB = new PortalDB(config);
        }

        /// <summary>
        /// Obtiene el catálogo fijo de reportes de la pantalla de Aplicación de Excedentes a Mora.
        /// </summary>
        ...
        {
            var lista = new List<CoAplExcInformeItemDto>
            {
                ...
                new() { codigo = "x03", descripcion = "Acuerdos de Aplicación de Excedentes a Mora" }
            };
        ...
        public ErrorDto<List<CoAplExcAplicacionF4Dto>> CO_AplExc_Informes_Aplicaciones_F4_Obtener(int CodEmpresa, string? texto)
        {
            ...
            try
            {
                ...
                var lista = conn.Query<CoAplExcAplicacionF4Dto>(sql, new
                {
                    texto,
                    like
                }).ToList();
            ...
            {
                return DbHelper.CreateErrorResponse<List<CoAplExcAplicacionF4Dto>>(
                    ex.Message,
                    -1,
                    new List<CoAplExcAplicacionF4Dto>());
            }
        }
        ...
        public ErrorDto<List<CoAplExcPersonaF4Dto>> CO_AplExc_Informes_Personas_F4_Obtener(int CodEmpresa, string? texto)
        {
            ...
            try
            {
                ...
                var lista = conn.Query<CoAplExcPersonaF4Dto>(sql, new
                {
                    texto,
                    like
                }).ToList();
            ...
            {
                return DbHelper.CreateErrorResponse<List<CoAplExcPersonaF4Dto>>(
                    ex.Message,
                    -1,
                    new List<CoAplExcPersonaF4Dto>());
            }
        }
    }
}