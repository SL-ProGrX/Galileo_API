...
namespace Galileo.DataBaseTier.ProGrX_Beneficios
{
    ...
    /// </summary>
    public partial class FrmAfBeneficiosAptProfesionalesDB : BeneficiosCatalogoDbBase
    {
        /// <summary>
        /// Inicializa el acceso a datos con la configuración inyectada.
        /// </summary>
        /// <param name="config">Configuración de la aplicación.</param>
        public FrmAfBeneficiosAptProfesionalesDB(IConfiguration config) : base(config)
        {
        }
