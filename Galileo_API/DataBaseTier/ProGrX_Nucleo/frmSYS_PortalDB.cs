    ...
    public class FrmSysPortalDB
    {
        ...
        public ErrorDto<SysMensajesPortalLista> Sys_MensajesPortal_Lista_Obtener(int CodEmpresa, FiltrosLazyLoadData filtros)
        {
            ...
            catch (Exception ex)
            {
                ...
                result.Result.lista = new List<SysMensajesPortalListaItem>();
            }
        ...
        public ErrorDto Sys_MensajesPortal_Mensaje_Guardar(int CodEmpresa, SysMensajesPortalDetalleModel dto, string usuario)
        {
            ...
            if (!ValidateGuardarMensaje(dto, ref r))
                return r;
        ...
        private static bool ValidateGuardarMensaje(SysMensajesPortalDetalleModel dto, ref ErrorDto r)
        {
        ...
        private static void NormalizeGuardarMensaje(SysMensajesPortalDetalleModel dto)
        {
            ...
            dto.tipo_formato_cod = (dto.tipo_formato_cod ?? string.Empty).Trim();
            dto.pie_01 = (dto.pie_01 ?? string.Empty).Trim();
        ...
        private static DynamicParameters BuildGuardarMensajeParams(SysMensajesPortalDetalleModel dto, string usuario)
        {
            var p = new DynamicParameters();
