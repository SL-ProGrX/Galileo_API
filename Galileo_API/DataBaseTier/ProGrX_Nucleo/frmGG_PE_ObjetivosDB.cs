    ...
    public class FrmGgPeObjetivosDb
    {
        ...
        public ErrorDto<PeObjetivosEstrategicosDatosLista> PeObjetivosEstrategicosLista_Obtener(int CodEmpresa, string Jfiltros)
        {
            ...
            try
            {
                ...
                {
                    where = "where O.objetivo_id LIKE '" + Percent + filtros.filtro + Percent + "'" + OrOperator +
                        "O.DESCRIPCION LIKE '" + Percent + filtros.filtro + Percent + "'" + OrOperator +
                        "O.nombre LIKE '" + Percent + filtros.filtro + Percent + "'" + OrOperator +
                        "O.indicador_clave LIKE '" + Percent + filtros.filtro + Percent + "'" + OrOperator +
                        "O.meta LIKE '" + Percent + filtros.filtro + Percent + "'" + OrOperator +
                        "O.unidad_medida LIKE '" + Percent + filtros.filtro + Percent + "'  ";
                }
