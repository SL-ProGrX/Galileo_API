...
{
    public class frmActivos_AdicionRetiroDB
    {
        ...
        public frmActivos_AdicionRetiroDB(IConfiguration? config)
        {
            _config = config;
        ...
        /// <summary>
        /// Metodo para guardar un registro de Adiciones, Mejoras o Retiros del Activo
        /// </summary>
        /// <param name="CodEmpresa"></param>
