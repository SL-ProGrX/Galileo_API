...
{
    public class frmActivos_MainDB
    {
                ...
                using var connection = new SqlConnection(stringConn);
                {
                    ...
                    else
                    {
                        if (placaAlternativa.Trim().Length > 0)
                        {
                            ...
                            int resultado2 = connection.Query<int>(query, new { placa, placaAlternativa }).FirstOrDefault();
        ...
        /// <summary>
        /// Metodo para consultar la fecha del ultimo periodo
        /// </summary>
        /// <param name="CodEmpresa"></param>
        /// <returns></returns>
