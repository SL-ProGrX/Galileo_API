...
namespace Galileo_API.DataBaseTier.ProGrX_Procesos.frmCC_ProcesoMensualDB.Archivos
{
    public class CcProcesoMensualArchivoF27RecopeGenerar : ICcProcesoMensualArchivoGenerator
    {
        ...
        private static CcProcesoMensualArchivoF27ConfigDbModel ObtenerConfiguracion(
            ...
            int codInstitucion)
        {
            ...
            return connection.QueryFirstOrDefault<CcProcesoMensualArchivoF27ConfigDbModel>(
                query,
                new { CodInstitucion = codInstitucion }) ?? new CcProcesoMensualArchivoF27ConfigDbModel();
        }

        private static List<string> ObtenerMovimientos(
            CcProcesoMensualArchivoF27ConfigDbModel configuracion)
        {
        ...
        private sealed class CcProcesoMensualArchivoF27ConfigDbModel
        {
