...
namespace Galileo_API.DataBaseTier.ProGrX_Procesos.frmCC_ProcesoMensualDB.Archivos
{
    public class CcProcesoMensualArchivoF32DxCGenerar : ICcProcesoMensualArchivoGenerator
    {
        ...
        private static CcProcesoMensualArchivoF32ConfigDbModel ObtenerConfiguracion(
            ...
            int codInstitucion)
        {
            ...
            return connection.QueryFirstOrDefault<CcProcesoMensualArchivoF32ConfigDbModel>(
                query,
                new { CodInstitucion = codInstitucion }) ?? new CcProcesoMensualArchivoF32ConfigDbModel();
        }

        private static List<string> ObtenerMovimientos(
            CcProcesoMensualArchivoF32ConfigDbModel configuracion)
        {
        ...
        private sealed class CcProcesoMensualArchivoF32ConfigDbModel
        {
