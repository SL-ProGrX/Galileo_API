...
namespace Galileo_API.DataBaseTier.ProGrX_Procesos.frmCC_ProcesoMensualDB.Archivos
{
    public class CcProcesoMensualArchivoF31ExcelPorzaCashGenerar : ICcProcesoMensualArchivoGenerator
    {
        ...
        private static CcProcesoMensualArchivoF31ConfigDbModel ObtenerConfiguracion(
            ...
            int codInstitucion)
        {
            ...
            return connection.QueryFirstOrDefault<CcProcesoMensualArchivoF31ConfigDbModel>(
                query,
                new { CodInstitucion = codInstitucion }) ?? new CcProcesoMensualArchivoF31ConfigDbModel();
        }

        private static List<string> ObtenerMovimientos(
            CcProcesoMensualArchivoF31ConfigDbModel configuracion)
        {
        ...
        private sealed class CcProcesoMensualArchivoF31ConfigDbModel
        {
