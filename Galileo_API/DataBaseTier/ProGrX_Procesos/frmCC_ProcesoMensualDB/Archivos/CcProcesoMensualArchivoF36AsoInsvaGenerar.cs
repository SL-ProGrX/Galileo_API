...
{
    public class CcProcesoMensualArchivoF36AsoInsvaGenerar : ICcProcesoMensualArchivoGenerator
    {
        private const string CodigoPlanillaEnvio = "36";
        ...
        private static CcProcesoMensualArchivoF36ConfigDbModel ObtenerConfiguracion(
            ...
            decimal fechaProceso)
        {
            ...
            return connection.QueryFirstOrDefault<CcProcesoMensualArchivoF36ConfigDbModel>(
                query,
                new
                {
                    CodInstitucion = codInstitucion,
                    FechaProceso = fechaProceso
                }) ?? new CcProcesoMensualArchivoF36ConfigDbModel();
        }
            ...
            DateTime fechaServidor)
        {
            ...
            return $"E-{codigoInstitucion}_{fechaProcesoTexto} [{fechaServidorTexto}-F36]{ExtensionTxt}";
        }

       
        private sealed class CcProcesoMensualArchivoF36ConfigDbModel
        {
