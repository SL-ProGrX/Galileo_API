...
namespace Galileo_API.DataBaseTier.ProGrX_Procesos.frmCC_ProcesoMensualDB.Archivos
{
    public class CcProcesoMensualArchivoF29PygGenerar : ICcProcesoMensualArchivoGenerator
    {
        ...
        private static CcProcesoMensualArchivoF29ConfigDbModel ObtenerConfiguracion(
            ...
            int codInstitucion)
        {
            ...
            return connection.QueryFirstOrDefault<CcProcesoMensualArchivoF29ConfigDbModel>(
                query,
                new { CodInstitucion = codInstitucion }) ?? new CcProcesoMensualArchivoF29ConfigDbModel();
        }

        private static List<string> ObtenerMovimientos(
            CcProcesoMensualArchivoF29ConfigDbModel configuracion)
        {
        ...
        private sealed class CcProcesoMensualArchivoF29ConfigDbModel
        {
