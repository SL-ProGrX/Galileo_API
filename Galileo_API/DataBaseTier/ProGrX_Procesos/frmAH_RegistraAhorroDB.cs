...
{
    public class frmAH_RegistraAhorroDB
    {
        private readonly IConfiguration _config;

        public frmAH_RegistraAhorroDB(IConfiguration config)
        {
            _config = config;
        }
        ...
        public ErrorDto Aplicar_Transacciones(int CodEmpresa, TransaccionSIFDTO transaccion)
        {
            ...
            try
            {
                ...
                //    @vNumDoc,
                //    @vTipoDoc,
                //    GETDATE(), --O la funci�n espec�fica para obtener la fecha actual en tu sistema
                //    @glodon_Usuario,
                //    @txtCedula,
                //    @txtNombre,
                //    'PAT001',
                //    @txtMonto, --Aseg�rate de que sea un tipo num�rico compatible
                //    'P',
                //    @txtCedula,
                //    '',
                //    '',
