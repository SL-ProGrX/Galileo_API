...
namespace Galileo.BusinessLogic
{
    public class FrmInvTranRequisicionesBL
    {
        ...
        public ErrorDto<TranRequisicionData> InvTranRequisicion_scroll(
            ...
            int? CodRequisicion)
        {
            return _db.InvTranRequisicion_scroll(
                CodEmpresa,
                scrollValue,
                CodRequisicion);
        }
        ...
        public ErrorDto InvTranRequesicion_Eliminar(
            ...
            int CodRequisicion)
        {
            return _db.InvTranRequesicion_Eliminar(
                CodEmpresa,
                CodRequisicion);
        }
        ...
        {
            return _db.InvRequesicionProduc_Insertar(
                CodEmpresa,
                CodRequisicion,
                producLineas);
        }
        ...
        public ErrorDto<List<TranRequisicionData>> InvTranPlantilla_Obtener(
            ...
            string? GeneraFecha)
        {
            return _db.InvTranPlantilla_Obtener(
                CodEmpresa,
                CodRequisicion,
                GeneraUser,
                GeneraFecha);
        ...
        public ErrorDto<List<TranRequisicionData>> InvTranRequisiciones_Lista(
            ...
            string estado)
        {
            return _db.InvTranRequisiciones_Lista(
                CodEmpresa,
                usuario,
                columna,
                estado);
        ...
        public ErrorDto InvRequisicionProduc_Eliminar(
            ...
            int Linea)
        {
            return _db.InvRequisicionProduc_Eliminar(
                CodEmpresa,
                CodRequisicion,
                Linea);
        }
        ...
        public ErrorDto<List<InvRequsUsuarioRecibe>>
            UsuarioRecibeLista_Obtener(
                ...
                string cod_unidad)
        {
            return _db.UsuarioRecibeLista_Obtener(
                CodEmpresa,
                cod_unidad);
        }
        ...
        {
            return _db.ProductosRequesicionesActivo_Obtener(
                CodEmpresa,
                invReqFiltros);
        }
