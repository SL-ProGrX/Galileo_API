...
namespace Galileo_API.BusinessLogic.ProGrX.Patrimonio
{
    public class FrmAhExcedentesTiposSalidasBL
    {
        ...
        {
            return _db.Patrimonio_frmAH_ExcedentesTiposSalidas_Lista(codEmpresa);
        }
        ...
        {
            return _db.Patrimonio_frmAH_ExcedentesTiposSalidas_Planes_Lista(codEmpresa);
        }
        ...
        {
            return _db.Patrimonio_frmAH_ExcedentesTiposSalidas_Bancos_Lista(codEmpresa);
        }
        ...
        {
            return _db.Patrimonio_frmAH_ExcedentesTiposSalidas_Insertar(codEmpresa, request);
        }
        ...
        public ErrorDto<FrmAhExcedentesTiposSalidasGuardarResponse> Patrimonio_frmAH_ExcedentesTiposSalidas_Actualizar(
            ...
            FrmAhExcedentesTiposSalidasGuardarRequest request)
        {
            return _db.Patrimonio_frmAH_ExcedentesTiposSalidas_Actualizar(codEmpresa, request);
        }
        ...
        public ErrorDto<bool> Patrimonio_frmAH_ExcedentesTiposSalidas_Eliminar(
            ...
            string usuario)
        {
            return _db.Patrimonio_frmAH_ExcedentesTiposSalidas_Eliminar(codEmpresa, codSalida, usuario);
        }
    }
}
