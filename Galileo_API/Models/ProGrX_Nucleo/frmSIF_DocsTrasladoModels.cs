...
namespace Galileo.Models.ProGrX_Nucleo
{
    ...
    public class SifDocsTrasladoEjecutarLoteRequest
    {
        public List<string> tiposDocumento { get; set; } = new List<string>();
        public DateTime fechaInicio { get; set; }
        public DateTime fechaFin { get; set; }
        public bool soloBalanceados { get; set; }
        public string? modo { get; set; }
    ...
    public class SifDocsTrasladoResultadoItem
    {
        public string tipoDocumento { get; set; } = "";
    ...
    public class SifDocsTrasladoResultadoLote
    {
        public int total { get; set; }
        public int ok { get; set; }
        public int fail { get; set; }
        public List<SifDocsTrasladoResultadoItem> detalle { get; set; } = new List<SifDocsTrasladoResultadoItem>();
    }
