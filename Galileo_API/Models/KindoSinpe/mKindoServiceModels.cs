...
namespace Galileo.Models.KindoSinpe
{
    ...
    //{
    //    private int CodeField { get; set; } = 0;
    //    private string MessageField { get; set; } = string.Empty;
    //    private int TypeField { get; set; } = 0;
    ...
    //public class Account
    //{
    //    private string AccountNumberField { get; set; } = string.Empty;
    //    private string CountryCodeField { get; set; } = string.Empty;
    //    private string CountryNameField { get; set; } = string.Empty;
    //    private string CurrencyCodeField { get; set; } = string.Empty;
    //    private int CurrencyHstIdField { get; set; } = 0;
    //    private string CurrencyNameField { get; set; } = string.Empty;
    //    private string CurrencySymbolField { get; set; } = string.Empty;
    //    private string EntityCodeField { get; set; } = string.Empty;
    //    private string EntityNameField { get; set; } = string.Empty;
    //    private string HolderField { get; set; } = string.Empty;
    //    private string HolderIdField { get; set; } = string.Empty;
    //    private int HolderIdTypeField { get; set; } = 0;
    //    private string HolderIdTypeNameField { get; set; } = string.Empty;
    //    private string ProductNameField { get; set; } = string.Empty;
    //    private string StateField { get; set; } = string.Empty;
    //    private string StateNameField { get; set; } = string.Empty;

    //    public string AccountNumber { get; set; } = string.Empty;
    //    public string CountryCode { get; set; } = string.Empty;
    //    public string CountryName { get; set; } = string.Empty;
    //    public string CurrencyCode { get; set; } = string.Empty;
    //    public int CurrencyHstId { get; set; } = 0;
    ...
    //    public int HolderIdType { get; set; } = 0;
    //    public string HolderIdTypeName { get; set; } = string.Empty;
