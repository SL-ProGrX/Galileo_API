...
namespace PgxAPI.Models.ProGrX.Cajas
{
    ...
    public class Cajas_SaldoFavorDTO
    {
    ...
    public class Cajas_DivisaFuncionalDTO
    {
        public string? divisa { get; set; }
    }


    public class Cajas_DepositosCuentasCancariasautdDTO
    {
    ...
    public sealed class Cajas_DesglocePagoDTO
    {
    ...
    public class Cajas_FormaPagoDto
    {
        public string cod_forma_pago { get; set; }
