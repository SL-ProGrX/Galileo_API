...
{
    public class TES_BancosGruposLista
    {
        public int total { get; set; } = 0;
        public List<TES_BancosGruposData> data { get; set; } = null;
    }


    public class TES_BancosGruposData
    {
    ...
    public class TES_BancosGruposImgData
    {
