namespace Galileo.Models.AH
{
    public class PatGestionesPatrimonio
    {
        ...
        public DateTime? registro_fecha { get; set; } = DateTime.MinValue;
    ...
    public sealed class PatGestionesBitacoraItem
    {
        public string id_autorizacion { get; set; } = string.Empty;
        public string cedula { get; set; } = string.Empty;
        public string nombre { get; set; } = string.Empty;
    ...
    public class FrmAhAutorizacionesProcesarRequest
    {
        public string usuario { get; set; } = string.Empty;
        public string accion { get; set; } = string.Empty;
        public List<string> ids_autorizacion { get; set; } = [];
    }

    public class FrmAhAutorizacionesProcesarResponse
    {
        public string accion { get; set; } = string.Empty;
        public string accion_desc { get; set; } = string.Empty;
        public int solicitudes_procesadas { get; set; } = 0;
