namespace Galileo_API.Models.ProGrX_Comites
{
    public class AfCdCuentaData
    {
        ...
        public int cod_director { get; set; } = 0;
    ...
    {
        public int cod_actividad { get; set; } = 0;
    ...
    public class AfCdCuentaRequest
    {
        public AfCdCuentaData cuenta { get; set; } = new AfCdCuentaData();
        public List<AfCdActividadData> actividades { get; set; } = new List<AfCdActividadData>();
        public List<AfCdCuentaData> refundiciones { get; set; } = new List<AfCdCuentaData>();
        public List<AfCdCargoData> cargos { get; set; } = new List<AfCdCargoData>();
